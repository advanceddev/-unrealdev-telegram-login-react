...
widgetVersion | number | ❌ | 24 | Версия виджета авторизации Telegram
...
loadingComponent | ReactNode | ❌ | undefined | Компонент (лоадер), отображающийся до отрисовки кнопки виджета 
...
Обнаружили уязвимость? Пожалуйста, следуйте нашей [политике безопасности](SECURITY.md).
